    ...
    <div className="p-4 w-full bg-base-100/80 backdrop-blur-sm border-t border-base-300/50">
      ...
      <form onSubmit={handleSendMessage} className="flex items-center gap-2">
        <div className="flex-1 flex gap-2">
          <input
            type="text"
            className="w-full input input-bordered rounded-xl input-sm sm:input-md focus:input-primary focus:ring-2 focus:ring-primary/20 transition-all"
          ...
          <button
            type="button"
            className={`hidden sm:flex btn btn-circle btn-ghost hover:bg-primary/10 transition-all
        ...
        <button
          type="submit"
          className="btn btn-circle btn-primary shadow-lg hover:shadow-xl hover:scale-105 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
